package com.ruilonglai.texas_scan.download;
...
public class DownLoadUtils {
    ...
    final String sdcardPath = "/mnt/sdcard/texas_scan/texas_scan_version.json";
    ...
    public long download(String uri, String title, String description,String appName) {
        ...
        downloadRequest.setDestinationInExternalPublicDir( "/desk_scan/", appName + ".apk");
        // 设置一些基本显示信息
